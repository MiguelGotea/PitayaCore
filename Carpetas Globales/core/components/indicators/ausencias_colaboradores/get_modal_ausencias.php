<?php
/**
 * Endpoint AJAX para Modal de Ausencias de Colaboradores
...
try {
    ...
    $indicator = new \Core\Components\Indicators\List\AusenciasColaboradoresIndicator($conn, '{}');

    // Obtener datos del modal
    $modalData = $indicator->getModalData($userId);

    // Renderizar el template del modal
    include 'ausencias_colaboradores_modal.php';

} catch (Exception $e) {
    http_response_code(500);
    error_log("Error en modal de ausencias: " . $e->getMessage());
