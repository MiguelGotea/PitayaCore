...
if ($LASTEXITCODE -ne 0) {
    Write-Host "⚠️ Conflicto detectado. Aplicando reparaciÃ³n de Hierro..." -ForegroundColor Yellow
...
Write-Host "✅ ¡PitayaCore actualizado con éxito!" -ForegroundColor Green
